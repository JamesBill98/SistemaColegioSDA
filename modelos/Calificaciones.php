...
//Edita un elemento identificado por su ID y actualiza su valor y otros datos relacionados.
...
//Verifica si un alumno tiene una asociación con un bloque específico.
...
//Lista las calificaciones de un alumno específico en un curso determinado.
...
//Desactiva un elemento específico identificado por su ID.
public function desactivar($id){ 
	$sql="UPDATE calification SET condicion='0' WHERE id='$id'";
	return ejecutarConsulta($sql);
}
//Activa un elemento específico identificado por su ID.
