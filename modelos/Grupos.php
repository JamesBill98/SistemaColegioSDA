...
//Función para editar o actualizar un elemento de grupo en la tabla de la base de datos.
...
//Función para invalidar o marcar un elemento de grupo como cancelado en la base de datos.
...
//Función para recuperar y mostrar información sobre un grupo de la base de datos.
public function mostrar_grupo($idgrupo){
	$sql="SELECT idgrupo,nombre,favorito, idusuario  FROM team WHERE idgrupo='$idgrupo'";
	return ejecutarConsulta($sql);
}

//Función para listar información detallada sobre un grupo de la base de datos.
...
//Función para recuperar información del encabezado de ventas para un grupo específico de la base de datos.
...
//Función para recuperar detalles de ventas para un grupo de la base de datos.
