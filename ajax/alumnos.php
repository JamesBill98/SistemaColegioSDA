<?php
//Requeriremos el archivo modelo 'Alumnos.php' para acceder a la clase Alumnos.
require_once "../modelos/Alumnos.php";
if (strlen(session_id())<1) 
	session_start();

// Crear una instancia de la clase "Alumnos"
$alumnos=new Alumnos();
...
switch ($_GET["op"]) {
	...
	// Caso de manejo de la operación 'desactivar'.
	case 'desactivar':
